function pronostico = descomposicionAditiva(datos)
%UNTITLED2 Descomposicion aditiva de los datos, con 4 periodos por año, y cantidad ENTERA de años.
...
factores = factores / (length(datos) / 4 - 1);
